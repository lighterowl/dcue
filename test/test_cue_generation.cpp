...
TEST(CueGeneration, r3446241) {
  auto const single_cue = std::array<std::vector<std::string_view>, 1>{{{
      R"cue(REM GENRE Europop)cue"sv,
      R"cue(REM DATE 2000)cue"sv,
      R"cue(REM COMMENT "DCue v1.6dev")cue"sv,
      R"cue(PERFORMER "Various")cue"sv,
      R"cue(TITLE "Studio 33 - The 34th Story")cue"sv,
      R"cue(FILE "r3446241.wav" WAVE)cue"sv,
      R"cue(	TRACK 01 AUDIO)cue"sv,
      R"cue(		TITLE "Intro")cue"sv,
      R"cue(		PERFORMER "Unknown Artist")cue"sv,
      R"cue(		INDEX 01 00:00:00)cue"sv,
      R"cue(	TRACK 02 AUDIO)cue"sv,
      R"cue(		TITLE "The Hampsterdance Song")cue"sv,
      R"cue(		PERFORMER "Hampton The Hampster")cue"sv,
      R"cue(		INDEX 01 01:01:00)cue"sv,
      R"cue(	TRACK 03 AUDIO)cue"sv,
      R"cue(		TITLE "Like A Butterfly")cue"sv,
      R"cue(		PERFORMER "A.B.A.")cue"sv,
      R"cue(		INDEX 01 01:46:00)cue"sv,
      R"cue(	TRACK 04 AUDIO)cue"sv,
      R"cue(		TITLE "Don't Take Away My Heart")cue"sv,
      R"cue(		PERFORMER "Modern Talking")cue"sv,
      R"cue(		INDEX 01 03:09:00)cue"sv,
      R"cue(	TRACK 05 AUDIO)cue"sv,
      R"cue(		TITLE "Feel The Beat (And Jump)")cue"sv,
      R"cue(		PERFORMER "DJ Promo")cue"sv,
      R"cue(		INDEX 01 04:24:00)cue"sv,
      R"cue(	TRACK 06 AUDIO)cue"sv,
      R"cue(		TITLE "Turn Around")cue"sv,
      R"cue(		PERFORMER "Paps N Skar")cue"sv,
      R"cue(		INDEX 01 05:45:00)cue"sv,
      R"cue(	TRACK 07 AUDIO)cue"sv,
      R"cue(		TITLE "Bang Bang Bang")cue"sv,
      R"cue(		PERFORMER "Mary C.")cue"sv,
      R"cue(		INDEX 01 06:57:00)cue"sv,
      R"cue(	TRACK 08 AUDIO)cue"sv,
      R"cue(		TITLE "Partyalarm (Und Ab Geht's)")cue"sv,
      R"cue(		PERFORMER "Aquagen")cue"sv,
      R"cue(		INDEX 01 07:56:00)cue"sv,
      R"cue(	TRACK 09 AUDIO)cue"sv,
      R"cue(		TITLE "Weekend")cue"sv,
      R"cue(		PERFORMER "Tantra")cue"sv,
      R"cue(		INDEX 01 08:37:00)cue"sv,
      R"cue(	TRACK 10 AUDIO)cue"sv,
      R"cue(		TITLE "All U DJs")cue"sv,
      R"cue(		PERFORMER "Triple 8")cue"sv,
      R"cue(		INDEX 01 09:50:00)cue"sv,
      R"cue(	TRACK 11 AUDIO)cue"sv,
      R"cue(		TITLE "Exzess")cue"sv,
      R"cue(		PERFORMER "DJ Taylor & Flow")cue"sv,
      R"cue(		INDEX 01 10:55:00)cue"sv,
      R"cue(	TRACK 12 AUDIO)cue"sv,
      R"cue(		TITLE "Toca's Miracle")cue"sv,
      R"cue(		PERFORMER "Fragma")cue"sv,
      R"cue(		INDEX 01 12:32:00)cue"sv,
      R"cue(	TRACK 13 AUDIO)cue"sv,
      R"cue(		TITLE "Lovin' Times")cue"sv,
      R"cue(		PERFORMER "Web")cue"sv,
      R"cue(		INDEX 01 13:39:00)cue"sv,
      R"cue(	TRACK 14 AUDIO)cue"sv,
      R"cue(		TITLE "Ravel's Pavane Pour Une Infante Défunte")cue"sv,
      R"cue(		PERFORMER "William Orbit")cue"sv,
      R"cue(		INDEX 01 14:49:00)cue"sv,
      R"cue(	TRACK 15 AUDIO)cue"sv,
      R"cue(		TITLE "Heaven")cue"sv,
      R"cue(		PERFORMER "Dune")cue"sv,
      R"cue(		INDEX 01 15:52:00)cue"sv,
      R"cue(	TRACK 16 AUDIO)cue"sv,
      R"cue(		TITLE "Piece Of Heaven")cue"sv,
      R"cue(		PERFORMER "A - Seven")cue"sv,
      R"cue(		INDEX 01 16:34:00)cue"sv,
      R"cue(	TRACK 17 AUDIO)cue"sv,
      R"cue(		TITLE "Maybe A Lonely Night")cue"sv,
      R"cue(		PERFORMER "Ken Laszlo Meets Morgana")cue"sv,
      R"cue(		INDEX 01 17:02:00)cue"sv,
      R"cue(	TRACK 18 AUDIO)cue"sv,
      R"cue(		TITLE "Hypnotize")cue"sv,
      R"cue(		PERFORMER "Qu-Zar")cue"sv,
      R"cue(		INDEX 01 18:26:00)cue"sv,
      R"cue(	TRACK 19 AUDIO)cue"sv,
      R"cue(		TITLE "Tell Me Why (The Riddle)")cue"sv,
      R"cue(		PERFORMER "Paul van Dyk Feat. Saint Etienne")cue"sv,
      R"cue(		INDEX 01 19:36:00)cue"sv,
      R"cue(	TRACK 20 AUDIO)cue"sv,
      R"cue(		TITLE "The Darkside")cue"sv,
      R"cue(		PERFORMER "Hypetraxx")cue"sv,
      R"cue(		INDEX 01 20:31:00)cue"sv,
      R"cue(	TRACK 21 AUDIO)cue"sv,
      R"cue(		TITLE "Danse Avec Moi!")cue"sv,
      R"cue(		PERFORMER "Kosmonova")cue"sv,
      R"cue(		INDEX 01 22:01:00)cue"sv,
      R"cue(	TRACK 22 AUDIO)cue"sv,
      R"cue(		TITLE "Do What You Like")cue"sv,
      R"cue(		PERFORMER "French Affair")cue"sv,
      R"cue(		INDEX 01 22:57:00)cue"sv,
      R"cue(	TRACK 23 AUDIO)cue"sv,
      R"cue(		TITLE "Another Way")cue"sv,
      R"cue(		PERFORMER "Gigi D'Agostino")cue"sv,
      R"cue(		INDEX 01 24:23:00)cue"sv,
      R"cue(	TRACK 24 AUDIO)cue"sv,
      R"cue(		TITLE "Around The World")cue"sv,
      R"cue(		PERFORMER "More")cue"sv,
      R"cue(		INDEX 01 25:38:00)cue"sv,
      R"cue(	TRACK 25 AUDIO)cue"sv,
      R"cue(		TITLE "Let It Be The Night")cue"sv,
      R"cue(		PERFORMER "Kim Lukas")cue"sv,
      R"cue(		INDEX 01 27:05:00)cue"sv,
      R"cue(	TRACK 26 AUDIO)cue"sv,
      R"cue(		TITLE "Doo-Whop")cue"sv,
      R"cue(		PERFORMER "Whigfield")cue"sv,
      R"cue(		INDEX 01 28:08:00)cue"sv,
      R"cue(	TRACK 27 AUDIO)cue"sv,
      R"cue(		TITLE "Voices")cue"sv,
      R"cue(		PERFORMER "Dario G.")cue"sv,
      R"cue(		INDEX 01 29:23:00)cue"sv,
      R"cue(	TRACK 28 AUDIO)cue"sv,
      R"cue(		TITLE "Love Bass")cue"sv,
      R"cue(		PERFORMER "WestBam")cue"sv,
      R"cue(		INDEX 01 30:08:00)cue"sv,
      R"cue(	TRACK 29 AUDIO)cue"sv,
      R"cue(		TITLE "Around The World")cue"sv,
      R"cue(		PERFORMER "Aqua")cue"sv,
      R"cue(		INDEX 01 31:10:00)cue"sv,
      R"cue(	TRACK 30 AUDIO)cue"sv,
      R"cue(		TITLE "Gimme! Gimme! Gimme! (A Man After Midnight)")cue"sv,
      R"cue(		PERFORMER "A-Teens")cue"sv,
      R"cue(		INDEX 01 32:31:00)cue"sv,
      R"cue(	TRACK 31 AUDIO)cue"sv,
      R"cue(		TITLE "My Console")cue"sv,
      R"cue(		PERFORMER "Eiffel 65")cue"sv,
      R"cue(		INDEX 01 33:49:00)cue"sv,
      R"cue(	TRACK 32 AUDIO)cue"sv,
      R"cue(		TITLE "I Wanna Be Free")cue"sv,
      R"cue(		PERFORMER "Mumm Vs. Dhany")cue"sv,
      R"cue(		INDEX 01 35:15:00)cue"sv,
      R"cue(	TRACK 33 AUDIO)cue"sv,
      R"cue(		TITLE "Need You Tonite (La La La)")cue"sv,
      R"cue(		PERFORMER "Quik  Feat. Charlotte")cue"sv,
      R"cue(		INDEX 01 36:43:00)cue"sv,
      R"cue(	TRACK 34 AUDIO)cue"sv,
      R"cue(		TITLE "Mama")cue"sv,
      R"cue(		PERFORMER "Asira")cue"sv,
      R"cue(		INDEX 01 37:35:00)cue"sv,
      R"cue(	TRACK 35 AUDIO)cue"sv,
      R"cue(		TITLE "Cry")cue"sv,
      R"cue(		PERFORMER "System F")cue"sv,
      R"cue(		INDEX 01 38:47:00)cue"sv,
      R"cue(	TRACK 36 AUDIO)cue"sv,
      R"cue(		TITLE "Feels Like Flyin'")cue"sv,
      R"cue(		PERFORMER "Woody van Eyden")cue"sv,
      R"cue(		INDEX 01 40:56:00)cue"sv,
      R"cue(	TRACK 37 AUDIO)cue"sv,
      R"cue(		TITLE "The Culture")cue"sv,
      R"cue(		PERFORMER "Hooligan")cue"sv,
      R"cue(		INDEX 01 41:38:00)cue"sv,
      R"cue(	TRACK 38 AUDIO)cue"sv,
      R"cue(		TITLE "Feel The Heat 2000")cue"sv,
      R"cue(		PERFORMER "Masterboy")cue"sv,
      R"cue(		INDEX 01 42:06:00)cue"sv,
      R"cue(	TRACK 39 AUDIO)cue"sv,
      R"cue(		TITLE "The Whistle Song")cue"sv,
      R"cue(		PERFORMER "DJ Aligator Project")cue"sv,
      R"cue(		INDEX 01 43:16:00)cue"sv,
      R"cue(	TRACK 40 AUDIO)cue"sv,
      R"cue(		TITLE "The Hampsterdance Song")cue"sv,
      R"cue(		PERFORMER "Hampton The Hampster")cue"sv,
      R"cue(		INDEX 01 43:46:00)cue"sv,
      R"cue(	TRACK 41 AUDIO)cue"sv,
      R"cue(		TITLE "Ylarie")cue"sv,
      R"cue(		PERFORMER "Suco E Sol")cue"sv,
      R"cue(		INDEX 01 44:58:00)cue"sv,
      R"cue(	TRACK 42 AUDIO)cue"sv,
      R"cue(		TITLE "Love Missile F1-11")cue"sv,
      R"cue(		PERFORMER "Sigue Sigue Sputnik")cue"sv,
      R"cue(		INDEX 01 45:55:00)cue"sv,
      R"cue(	TRACK 43 AUDIO)cue"sv,
      R"cue(		TITLE "Partyalarm (Und Ab Geht's)")cue"sv,
      R"cue(		PERFORMER "Aquagen")cue"sv,
      R"cue(		INDEX 01 47:28:00)cue"sv,
      R"cue(	TRACK 44 AUDIO)cue"sv,
      R"cue(		TITLE "Dirty Bitch")cue"sv,
      R"cue(		PERFORMER "Avancada")cue"sv,
      R"cue(		INDEX 01 48:03:00)cue"sv,
      R"cue(	TRACK 45 AUDIO)cue"sv,
      R"cue(		TITLE "Thong Song")cue"sv,
      R"cue(		PERFORMER "Sisqo")cue"sv,
      R"cue(		INDEX 01 48:17:00)cue"sv,
      R"cue(	TRACK 46 AUDIO)cue"sv,
      R"cue(		TITLE "Wonderland")cue"sv,
      R"cue(		PERFORMER "Passion Fruit")cue"sv,
      R"cue(		INDEX 01 49:52:00)cue"sv,
      R"cue(	TRACK 47 AUDIO)cue"sv,
      R"cue(		TITLE "Gimme More Huhn")cue"sv,
      R"cue(		PERFORMER "Moorhuhn Feat. Wigald Boning")cue"sv,
      R"cue(		INDEX 01 50:43:00)cue"sv,
      R"cue(	TRACK 48 AUDIO)cue"sv,
      R"cue(		TITLE "Feel It")cue"sv,
      R"cue(		PERFORMER "Layton & Stone")cue"sv,
      R"cue(		INDEX 01 52:01:00)cue"sv,
      R"cue(	TRACK 49 AUDIO)cue"sv,
      R"cue(		TITLE "Stop Playing With My Mind")cue"sv,
      R"cue(		PERFORMER "Barbara Tucker")cue"sv,
      R"cue(		INDEX 01 52:47:00)cue"sv,
      R"cue(	TRACK 50 AUDIO)cue"sv,
      R"cue(		TITLE "Lucky Star")cue"sv,
      R"cue(		PERFORMER "Superfunk Feat. Ron Carroll")cue"sv,
      R"cue(		INDEX 01 53:17:00)cue"sv,
      R"cue(	TRACK 51 AUDIO)cue"sv,
      R"cue(		TITLE "Last Night")cue"sv,
      R"cue(		PERFORMER "Giorgio Moroder Project Pres. Gloria Gaynor")cue"sv,
      R"cue(		INDEX 01 54:17:00)cue"sv,
      R"cue(	TRACK 52 AUDIO)cue"sv,
      R"cue(		TITLE "Off The Wall (Enjoy Yourself)")cue"sv,
      R"cue(		PERFORMER "Wisdome")cue"sv,
      R"cue(		INDEX 01 55:10:00)cue"sv,
      R"cue(	TRACK 53 AUDIO)cue"sv,
      R"cue(		TITLE "Love Come Home")cue"sv,
      R"cue(		PERFORMER "DJ Jean")cue"sv,
      R"cue(		INDEX 01 55:54:00)cue"sv,
      R"cue(	TRACK 54 AUDIO)cue"sv,
      R"cue(		TITLE "I Will Love Again")cue"sv,
      R"cue(		PERFORMER "Lara Fabian")cue"sv,
      R"cue(		INDEX 01 56:54:00)cue"sv,
      R"cue(	TRACK 55 AUDIO)cue"sv,
      R"cue(		TITLE "I Promised Myself")cue"sv,
      R"cue(		PERFORMER "John Davies")cue"sv,
      R"cue(		INDEX 01 58:15:00)cue"sv,
      R"cue(	TRACK 56 AUDIO)cue"sv,
      R"cue(		TITLE "At The Club")cue"sv,
      R"cue(		PERFORMER "SM Trax")cue"sv,
      R"cue(		INDEX 01 58:46:00)cue"sv,
      R"cue(	TRACK 57 AUDIO)cue"sv,
      R"cue(		TITLE "Freestyler")cue"sv,
      R"cue(		PERFORMER "Bomfunk MC's")cue"sv,
      R"cue(		INDEX 01 59:31:00)cue"sv,
      R"cue(	TRACK 58 AUDIO)cue"sv,
      R"cue(		TITLE "Bongo Bong")cue"sv,
      R"cue(		PERFORMER "Manu Chao")cue"sv,
      R"cue(		INDEX 01 60:18:00)cue"sv,
      R"cue(	TRACK 59 AUDIO)cue"sv,
      R"cue(		TITLE "Daily")cue"sv,
      R"cue(		PERFORMER "TQ")cue"sv,
      R"cue(		INDEX 01 61:16:00)cue"sv,
      R"cue(	TRACK 60 AUDIO)cue"sv,
      R"cue(		TITLE "He Wasn't Man Enough")cue"sv,
      R"cue(		PERFORMER "Toni Braxton")cue"sv,
      R"cue(		INDEX 01 62:01:00)cue"sv,
      R"cue(	TRACK 61 AUDIO)cue"sv,
      R"cue(		TITLE "Abcd")cue"sv,
      R"cue(		PERFORMER "Four Colourz")cue"sv,
      R"cue(		INDEX 01 63:04:00)cue"sv,
      R"cue(	TRACK 62 AUDIO)cue"sv,
      R"cue(		TITLE "Ohne Dich (Schlaf' Ich Heut Nacht Nicht Ein)")cue"sv,
      R"cue(		PERFORMER "Marvin McKay Feat. Seven")cue"sv,
      R"cue(		INDEX 01 63:28:00)cue"sv,
      R"cue(	TRACK 63 AUDIO)cue"sv,
      R"cue(		TITLE "Wen Soll Ich Fürchten")cue"sv,
      R"cue(		PERFORMER "Aleksey")cue"sv,
      R"cue(		INDEX 01 63:54:00)cue"sv,
      R"cue(	TRACK 64 AUDIO)cue"sv,
      R"cue(		TITLE "Play Around")cue"sv,
      R"cue(		PERFORMER "Lil' Cease")cue"sv,
      R"cue(		INDEX 01 64:15:00)cue"sv,
      R"cue(	TRACK 65 AUDIO)cue"sv,
      R"cue(		TITLE "Oops!...I Did It Again")cue"sv,
      R"cue(		PERFORMER "Britney Spears")cue"sv,
      R"cue(		INDEX 01 64:35:00)cue"sv,
      R"cue(	TRACK 66 AUDIO)cue"sv,
      R"cue(		TITLE "Riddle")cue"sv,
      R"cue(		PERFORMER "En Vogue")cue"sv,
      R"cue(		INDEX 01 65:36:00)cue"sv,
      R"cue(	TRACK 67 AUDIO)cue"sv,
      R"cue(		TITLE "Let Me Be The One")cue"sv,
      R"cue(		PERFORMER "Sasha")cue"sv,
      R"cue(		INDEX 01 65:56:00)cue"sv,
      R"cue(	TRACK 68 AUDIO)cue"sv,
      R"cue(		TITLE "Tom's Diner 2000 (Do My Thang)")cue"sv,
      R"cue(		PERFORMER "T-One")cue"sv,
      R"cue(		INDEX 01 66:57:00)cue"sv,
      R"cue(	TRACK 69 AUDIO)cue"sv,
      R"cue(		TITLE "Get It On Tonite")cue"sv,
      R"cue(		PERFORMER "Montell Jordan")cue"sv,
      R"cue(		INDEX 01 67:26:00)cue"sv,
      R"cue(	TRACK 70 AUDIO)cue"sv,
      R"cue(		TITLE "Candy")cue"sv,
      R"cue(		PERFORMER "Mandy Moore")cue"sv,
      R"cue(		INDEX 01 68:05:00)cue"sv,
      R"cue(	TRACK 71 AUDIO)cue"sv,
      R"cue(		TITLE "Leb!")cue"sv,
      R"cue(		PERFORMER "Die 3. Generation")cue"sv,
      R"cue(		INDEX 01 68:44:00)cue"sv,
      R"cue(	TRACK 72 AUDIO)cue"sv,
      R"cue(		TITLE "Follow You Follow Me")cue"sv,
      R"cue(		PERFORMER "Sonny Jones Feat. Tara Chase")cue"sv,
      R"cue(		INDEX 01 69:27:00)cue"sv,
      R"cue(	TRACK 73 AUDIO)cue"sv,
      R"cue(		TITLE "Stop")cue"sv,
      R"cue(		PERFORMER "Jon Secada")cue"sv,
      R"cue(		INDEX 01 70:23:00)cue"sv,
      R"cue(	TRACK 74 AUDIO)cue"sv,
      R"cue(		TITLE "Gimme A Thrill")cue"sv,
      R"cue(		PERFORMER "Snap")cue"sv,
      R"cue(		INDEX 01 70:59:00)cue"sv,
      R"cue(	TRACK 75 AUDIO)cue"sv,
      R"cue(		TITLE "The One")cue"sv,
      R"cue(		PERFORMER "Backstreet Boys")cue"sv,
      R"cue(		INDEX 01 71:26:00)cue"sv,
      R"cue(	TRACK 76 AUDIO)cue"sv,
      R"cue(		TITLE "Heaven Is For Everyone")cue"sv,
      R"cue(		PERFORMER "Touché")cue"sv,
      R"cue(		INDEX 01 72:23:00)cue"sv
  }}};
  test_cue_generation(single_cue, *multitrack_strategy::single());

  auto const merged_cue = std::array<std::vector<std::string_view>, 1>{{{
      R"cue(REM GENRE Europop)cue"sv,
      R"cue(REM DATE 2000)cue"sv,
      R"cue(REM COMMENT "DCue v1.6dev")cue"sv,
      R"cue(PERFORMER "Various")cue"sv,
      ...
      R"cue(FILE "r3446241.wav" WAVE)cue"sv,
      R"cue(	TRACK 01 AUDIO)cue"sv,
      R"cue(		TITLE "Intro - Ich Vermiss Dich.. (Wie Die Hölle) - Das Moorhuhn")cue"sv,
      R"cue(		PERFORMER "Unknown Artist - Zlatko - M-Pac")cue"sv,
      R"cue(		INDEX 01 00:00:00)cue"sv,
      R"cue(	TRACK 02 AUDIO)cue"sv,
      R"cue(		TITLE "The Hampsterdance Song - Feel The Rhythm Of The Night")cue"sv,
      R"cue(		PERFORMER "Hampton The Hampster - Judy Ross")cue"sv,
      R"cue(		INDEX 01 01:01:00)cue"sv,
      R"cue(	TRACK 03 AUDIO)cue"sv,
      R"cue(		TITLE "Like A Butterfly - Beautiful World - Partyalarm (Und Ab Geht's)")cue"sv,
      R"cue(		PERFORMER "A.B.A. - Lady Violet - Aquagen")cue"sv,
      R"cue(		INDEX 01 01:46:00)cue"sv,
      R"cue(	TRACK 04 AUDIO)cue"sv,
      R"cue(		TITLE "Don't Take Away My Heart - Dance Police")cue"sv,
      R"cue(		PERFORMER "Modern Talking - Houseless")cue"sv,
      R"cue(		INDEX 01 03:09:00)cue"sv,
      R"cue(	TRACK 05 AUDIO)cue"sv,
      R"cue(		TITLE "Feel The Beat (And Jump) - The Summer")cue"sv,
      R"cue(		PERFORMER "DJ Promo - ATB")cue"sv,
      R"cue(		INDEX 01 04:24:00)cue"sv,
      R"cue(	TRACK 06 AUDIO)cue"sv,
      R"cue(		TITLE "Turn Around")cue"sv,
      R"cue(		PERFORMER "Paps N Skar")cue"sv,
      ...
      R"cue(		INDEX 01 06:57:00)cue"sv,
      R"cue(	TRACK 08 AUDIO)cue"sv,
      R"cue(		TITLE "Partyalarm (Und Ab Geht's) - No More Turning Back!!")cue"sv,
      R"cue(		PERFORMER "Aquagen - Gitta")cue"sv,
      R"cue(		INDEX 01 07:56:00)cue"sv,
      R"cue(	TRACK 09 AUDIO)cue"sv,
      R"cue(		TITLE "Weekend - Keep On Dancing")cue"sv,
      R"cue(		PERFORMER "Tantra - DJ Maui")cue"sv,
      R"cue(		INDEX 01 08:37:00)cue"sv,
      R"cue(	TRACK 10 AUDIO)cue"sv,
      R"cue(		TITLE "All U DJs - Will I Ever")cue"sv,
      R"cue(		PERFORMER "Triple 8 - Alice Deejay")cue"sv,
      R"cue(		INDEX 01 09:50:00)cue"sv,
      R"cue(	TRACK 11 AUDIO)cue"sv,
      R"cue(		TITLE "Exzess - Sleep")cue"sv,
      R"cue(		PERFORMER "DJ Taylor & Flow - X-Treme")cue"sv,
      R"cue(		INDEX 01 10:55:00)cue"sv,
      R"cue(	TRACK 12 AUDIO)cue"sv,
      R"cue(		TITLE "Toca's Miracle")cue"sv,
      R"cue(		PERFORMER "Fragma")cue"sv,
      ...
      R"cue(		INDEX 01 22:57:00)cue"sv,
      R"cue(	TRACK 23 AUDIO)cue"sv,
      R"cue(		TITLE "Another Way - Vamoz Everybody")cue"sv,
      R"cue(		PERFORMER "Gigi D'Agostino - Jump'n Joy")cue"sv,
      R"cue(		INDEX 01 24:23:00)cue"sv,
      R"cue(	TRACK 24 AUDIO)cue"sv,
      R"cue(		TITLE "Around The World")cue"sv,
      R"cue(		PERFORMER "More")cue"sv,
      ...
      R"cue(		INDEX 01 33:49:00)cue"sv,
      R"cue(	TRACK 32 AUDIO)cue"sv,
      R"cue(		TITLE "I Wanna Be Free - Saturday")cue"sv,
      R"cue(		PERFORMER "Mumm Vs. Dhany - Block 15")cue"sv,
      R"cue(		INDEX 01 35:15:00)cue"sv,
      R"cue(	TRACK 33 AUDIO)cue"sv,
      R"cue(		TITLE "Need You Tonite (La La La)")cue"sv,
      R"cue(		PERFORMER "Quik  Feat. Charlotte")cue"sv,
      R"cue(		INDEX 01 36:43:00)cue"sv,
      R"cue(	TRACK 34 AUDIO)cue"sv,
      R"cue(		TITLE "Mama - No Sleep")cue"sv,
      R"cue(		PERFORMER "Asira - N.Y.C.C.")cue"sv,
      R"cue(		INDEX 01 37:35:00)cue"sv,
      R"cue(	TRACK 35 AUDIO)cue"sv,
      R"cue(		TITLE "Cry - Technodisco - Running 2.0")cue"sv,
      R"cue(		PERFORMER "System F - Nick Beat - Tyrell Corp.")cue"sv,
      R"cue(		INDEX 01 38:47:00)cue"sv,
      R"cue(	TRACK 36 AUDIO)cue"sv,
      R"cue(		TITLE "Feels Like Flyin' - Wer Ist Shakesbier ?")cue"sv,
      R"cue(		PERFORMER "Woody van Eyden - Keine Ahnung Feat. Big Brain")cue"sv,
      R"cue(		INDEX 01 40:56:00)cue"sv,
      R"cue(	TRACK 37 AUDIO)cue"sv,
      R"cue(		TITLE "The Culture - Eichelrück - Science Fiction - Day By Day - Keep On Dancing")cue"sv,
      R"cue(		PERFORMER "Hooligan - Da Hool - Taucher - Miss Peppermint - DJ Maui")cue"sv,
      R"cue(		INDEX 01 41:38:00)cue"sv,
      R"cue(	TRACK 38 AUDIO)cue"sv,
      R"cue(		TITLE "Feel The Heat 2000")cue"sv,
      R"cue(		PERFORMER "Masterboy")cue"sv,
      R"cue(		INDEX 01 42:06:00)cue"sv,
      R"cue(	TRACK 39 AUDIO)cue"sv,
      R"cue(		TITLE "The Whistle Song - Pussylovers")cue"sv,
      R"cue(		PERFORMER "DJ Aligator Project - Balloon")cue"sv,
      R"cue(		INDEX 01 43:16:00)cue"sv,
      R"cue(	TRACK 40 AUDIO)cue"sv,
      R"cue(		TITLE "The Hampsterdance Song")cue"sv,
      R"cue(		PERFORMER "Hampton The Hampster")cue"sv,
      R"cue(		INDEX 01 43:46:00)cue"sv,
      R"cue(	TRACK 41 AUDIO)cue"sv,
      R"cue(		TITLE "Ylarie - All U DJs")cue"sv,
      R"cue(		PERFORMER "Suco E Sol - Triple 8")cue"sv,
      R"cue(		INDEX 01 44:58:00)cue"sv,
      R"cue(	TRACK 42 AUDIO)cue"sv,
      R"cue(		TITLE "Love Missile F1-11")cue"sv,
      R"cue(		PERFORMER "Sigue Sigue Sputnik")cue"sv,
      R"cue(		INDEX 01 45:55:00)cue"sv,
      R"cue(	TRACK 43 AUDIO)cue"sv,
      R"cue(		TITLE "Partyalarm (Und Ab Geht's) - Time To Burn")cue"sv,
      R"cue(		PERFORMER "Aquagen - Storm")cue"sv,
      R"cue(		INDEX 01 47:28:00)cue"sv,
      R"cue(	TRACK 44 AUDIO)cue"sv,
      R"cue(		TITLE "Dirty Bitch")cue"sv,
      R"cue(		PERFORMER "Avancada")cue"sv,
  ...
  test_cue_generation(merged_cue, *multitrack_strategy::merge());
}
